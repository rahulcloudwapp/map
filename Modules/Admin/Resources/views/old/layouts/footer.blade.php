<div class="modal" id="myModal" role="dialog" >
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content modal-new modal-medical">
       <form action="" enctype="multipart/form-data" method="post" accept-charset="utf-8">
           @csrf
        <div class="modal-header">
          <div class="row">
            <div class="col-md-6">
              <h4 id="data_type">Images</h4>
            </div>
            <div class="col-md-6">
        ...
        <div class="modal-body">
         ...
         <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2019 <a href="{{url('admin')}}">ArtAvenue</a>.</strong> All rightsreserved.
         </footer>
         <!-- Control Sidebar -->
...
<script src="{{ url('public/Admin/') }}/assets/dist/js/demo.js"></script>
      ...
      <!-- AdminLTE for demo purposes -->
      <script src="{{ url('public/Admin/') }}/assets/dist/js/demo.js"></script>
      <script src="{{ url('public/Admin/') }}/assets/dist/js/bootstrap-editable.min.js"></script>
...
<script type="text/javascript" src="{{url('public/Admin/') }}/assets/dist/js/image1-uploader.min.js"></script>
<script>
    $(function () {
